    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" href="https://wa.me/2945697030">
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/senderearporesquel?utm_source=ig_web_button_share_sheet&igsh=MTM1Nmtpb3l2eG13eA==">
            <div className="filled" />
